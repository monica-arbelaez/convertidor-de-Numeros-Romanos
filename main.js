...
//     let arabic = document.getElementById('num1').value;

//     let romanNumber = '';
// //    Pone el arreglo al revés 
//     const decimalKeys = Object.keys(romanObj).reverse();
...
//  return romanNumber;
// }
// let button_romanos = document.getElementById("num2");
